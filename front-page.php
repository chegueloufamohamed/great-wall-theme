...
?>
    ...
    <div class="container">
      ...
      <div class="grid popular-grid">
        ...
        if ( class_exists( 'WooCommerce' ) ) {
            ...
            $display_chairs = array_slice( $oc_products, 0, 10 );

            if ( ! empty( $display_chairs ) ) {
                $delay = 100;
                foreach ( $display_chairs as $post_obj ) {
  ...
  <!-- ==========================================================================
       SIGNATURE FURNITURE PIECES SECTION (Original static mockup items)
       ========================================================================== -->
  <section class="section popular-products-section">
    <div class="container">
      <div class="popular-products-title-wrapper" data-scroll>
        <h2 class="popular-products-title">Signature Collections</h2>
      </div>
